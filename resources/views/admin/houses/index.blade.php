...
<section class="index">
    ...
    <div class="container">
        <div class="d-flex align-items-center py-5">
            ...
            <button class="ms-auto me-2"><a href="{{route('admin.houses.create')}}" class="link-underline link-underline-opacity-0">Crea Nuovo</a></button>
            <div>
                @if(request('trash'))
                        ...
                        <div>
                            @auth
                                @if($house->user_id === Auth::id() && !$house ->trashed())
                                    <button class="me-3"><a href="{{route('admin.houses.edit',$house)}}"class="link-underline link-underline-opacity-0">Modifica</a></button>
